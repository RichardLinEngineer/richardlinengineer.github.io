...
\begin{itemize}
    \item Manage IEEE-HKN Headquarters correspondence, chapter finances, and induction/member events
\end{itemize}
...
\textbf{AI \& Robotics:} LLM Integration, RAG, VLA, Edge AI, Computer Vision (OpenCV, YOLO), TTS/STT, Multi-Agent Systems, ROS \\[1pt]
